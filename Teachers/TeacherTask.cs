...
namespace Console_Attendance_Mgt_system.Teachers
{
    internal class TeacherTask
    {
        ...
        public void TeacherDashboard()
        {
            ...
            do
            {
                ...
                switch (Tchoice)
                {
                    ...
                    case 4: int? tid = -1;
                        getTeacherID(out tid);
                        Teacher_reports.Show_Attendance_Class_subjectWise(tid); break;
                    default:
                        break;
                }
        ...
        public static SqlDataReader GetStudents(int class_id)
        {
        ...
        public static void getSubjectDetails(int classID, out int subId, out string subName)
        {
        ...
        public static void getClassID(out int clsid, out string clsName)
        {
            clsid = -1;
            clsName = "";
            SqlConnection con = new SqlConnection(Properties.Settings.Default.MyConString);
